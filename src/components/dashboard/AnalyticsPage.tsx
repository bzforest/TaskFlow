        ...
        <div className="flex flex-col h-full gap-6" >
            ...
            <div className='flex items-center justify-start mt-2'>
                <div>
                    ...
                    <p className='text-status-gray-text mt-1 text-sm pt-1'>
            ...
            <div className='flex justify-end pr-6'>
                <button
                    ...
                    className='flex items-center justify-center gap-2 bg-white dark:bg-brand-blue/60 border border-brand-grey-border dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-blue-900/60 text-brand-purple dark:text-brand-grey-border px-4 py-2 rounded-lg font-medium transition-colors shadow-sm disabled:opacity-50 cursor-pointer hover:scale-[1.02] focus:scale-100 w-40'
                >
            ...
            {/* Graph */}
            <div className='flex-1 bg-white dark:bg-brand-navy rounded-2xl border border-brand-grey-border dark:border-gray-800 p-6 shadow-sm min-h-[450px]' ref={pdfRef}>
